...
export const en = {
  ...
  categories: {
    ...
    footerCopyright: 'Offline ToolHub. All tools are free to use.',
    utility: {
  ...
  tools: {
    ...
    'ai-photo-cutout': {
      ...
      longDescription:
        'AI Photo Cutout uses the IS-Net FP16 model to separate people, products, animals, and objects from their backgrounds. It runs entirely in your browser through WebAssembly, so images never leave your device. Refine the mask with a brush, then fill the removed area from similar surrounding colors or use the LaMa repair model for complex backgrounds. Preview the foreground, original image, and completed background before downloading.',
      features: ['AI auto cutout', 'Two background fill methods', 'Foreground + Background', '100% private'],
      ui: {
        ...
        restore: 'Keep foreground',
        erase: 'Remove foreground',
        ...
        zoomIn: 'Zoom in',
        fit: 'Fit to view',
        rebuildingBackground: 'Rebuilding background...',
        backgroundFill: 'Background fill',
        fillAuto: 'Auto',
        fillColor: 'Color fill',
        fillAi: 'AI repair',
        detectedColorFill: 'Similar surrounding colors detected: color fill will be used.',
        detectedAiFill: 'Complex surrounding colors detected: AI repair will be used.',
        colorFillNote: 'Uses nearby colors to fill the removed area.',
        aiFillNote: 'The AI repair model is about 62 MB and is cached after the first use.',
        aiDownloading: 'Downloading AI repair model: {percent}%',
        aiInitializing: 'Initializing AI repair model...',
        aiRepairing: 'AI is repairing the background...',
        aiProgressTitle: 'AI background repair',
        aiStageDownload: 'Download model',
        aiStageInitialize: 'Initialize model',
        aiStageInference: 'AI inference',
        downloadFg: 'Download Foreground',
        downloadBg: 'Download Background',
        startOver: 'Start over with a new image',
        modelName: 'IS-Net FP16',
        modelWarning: 'The first use downloads the IS-Net FP16 model and runtime files. They are cached for later use.',
    ...
    'portrait-cutout': {
      ...
      longDescription:
        'Portrait Cutout uses Google MediaPipe Selfie Segmentation to separate people from backgrounds in real time. The model is tiny (~25 KB) and runs entirely in your browser. Refine the mask with a brush, then preview the transparent foreground, original photo, and content-filled background before downloading.',
